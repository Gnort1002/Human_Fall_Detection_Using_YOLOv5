...
class ObjectDetection:
    ...
    def load_model(self):
        ...
        #model = torch.hub.load('.', 'custom', path=r'/yolov5/runs/train/exp4/weights/best.pt', source='local')
        #model = torch.hub.load('ultralytics/yolov5', 'custom', path='/home/gnort/Study/AIP/Image-based-Human-Fall-Detection-main-2/yolov5/runs/train/exp4/weights/best.pt', force_reload=True) 
...
detection = ObjectDetection(r"https://www.youtube.com/watch?v=t_oZDKnUyIk&list=PPSV", "video3.avi")
detection()